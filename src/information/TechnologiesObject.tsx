...
/*
	...
	Find more icons here: https://simple-icons.github.io/simple-icons-website/
	...
	Passing in both size and color allows for you to make all icons the same color throughout your portfolio
...
export function TechnologiesObject(
	...
	return {
		...
		// get icons from https://simple-icons.github.io/simple-icons-website/
	};
}
